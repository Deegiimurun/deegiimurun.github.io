...
<main draggable="false" on:dragstart|preventDefault>
    ...
    <Icon
        ...
        text="Github"
        on:dblclick={() => {
            window.open("https://github.com/deegiimurun", "_blank");
        }}
    />
    <Icon
        top="5rem"
        ...
        text="Mail me"
        on:dblclick={() => {
            window.location.href = "mailto:deegiimurun@gmail.com";
        }}
    />
    <Icon
        top="10rem"
        ...
        on:dblclick={() => {
            window.open(
                "https://www.linkedin.com/in/delgermurun-damdin-7656b8165",
                "_blank"
            );
        }}
    />
